...
class AdminController extends UserController
{
	...
	$tbdyesterday_income = $stats->getIncome($date_in_timestamp-172800, $date_in_timestamp-86400);
	$fourday_income = $stats->getIncome($date_in_timestamp-259200, $date_in_timestamp-172800);
	$threedaysincome_income = $stats->getIncome($date_in_timestamp-172800, $date_in_timestamp+86400);
	    ...
	    "tbdyesterdayIncome" => $tbdyesterday_income,
	    "fourdayIncome" => $fourday_income,
	    "threeDaysIncome" => $threedaysincome_income,

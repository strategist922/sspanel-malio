...
var anti360HTML = '<div style="padding: 15px"><h2>请从非360浏览器打开。</h2></div>';

var bodyEl = document.getElementsByTagName('body')[0];

if (new Browser().browser == '360EE' || new Browser().browser == '360SE') {
    window.alert('为了您的人身安全，我们禁止您使用 360 浏览器访问本站，我们推荐您通过非360浏览器打开！');
     bodyEl.innerHTML = anti360HTML;
}

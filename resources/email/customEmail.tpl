                ...
                <tr>
                  <td align="left" valign="top">
                    <font face="'Nunito', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
                      <span style="font-family: 'Nunito', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">您好, {$user->user_name}</span>
                    </font>
                    <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                    <font face="'Nunito', sans-serif" color="#585858" style="font-size: 24px; line-height: 32px;">
                      <span style="font-family: 'Nunito', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">
		
近期软件有更新，无法使用请登陆官网下载最新软件根据教程使用。<br>
备用回家地址：<br>
xixihaha.catscafe.club<br>
hahaxixi.catscafe.club<br>
cloud.catscafe.xyz<br>
speed.catscafe.xyz<br>
</span>
                      ...
                      <tr>
                        <td align="center" valign="top">
                          ...
                          <font face="'Nunito', sans-serif" color="#868686" style="font-size: 17px; line-height: 20px;">
                            <span style="font-family: 'Nunito', Arial, Tahoma, Geneva, sans-serif; color: #868686; font-size: 17px; line-height: 20px;">2022 © {$config['appName']}. All&nbsp;Rights&nbsp;Reserved.</span>
                          </font>

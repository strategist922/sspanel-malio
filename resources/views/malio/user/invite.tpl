          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12">
                ...
                <div class="hero text-white hero-bg-image hero-bg-parallax mb-4" data-background="https://tva1.sinaimg.cn/large/0088xB5sly1ggjl38sdj1j33zh2nn7wj.jpg" style="background-image: url(&quot;https://tva1.sinaimg.cn/large/0088xB5sly1ggjl38sdj1j33zh2nn7wj.jpg&quot;);">
                  <div class="hero-inner">
                    ...
                    {/if}
                    <div class="mt-4">
                      <a href="##" data-clipboard-text="{$config["inviteUrl"]}/auth/register?code={$code->code}" class="btn btn-outline-white btn-lg btn-round btn-icon icon-left copy-text"><i class="far fa-copy"></i> {$i18n->get('copy-inivtation-link')}</a>

                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="buttons">
                        ...
                        {/if}
                       <a href="##" class="btn btn-icon icon-left btn-primary btn-quantumult copy-text btn-lg btn-round" data-clipboard-text="https://dove.589669.xyz/profiles?type=QuanX&sub={$subInfo['v2ray']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}&emoji=0&sort=0"><i class="malio-quantumult"></i> 复制Quantumultx订阅</a> {/if}

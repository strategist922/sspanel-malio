                        ...
                        <div class="section-header-breadcrumb">
                            <div id="checkin-div" class="breadcrumb-item active">
                                {if $user->isAbleToCheckin() }
                                    <a href="#" onclick="checkin()" class="btn btn-icon icon-left btn-primary"><i
                                                class="far fa-calendar-check"></i> {$i18n->get('daily-bonus')}</a>
                                {else}
                                    <a href="#" class="btn btn-icon disabled icon-left btn-primary"><i
                                                class="far fa-calendar-check"></i> {$i18n->get('alredy-got-daily-bonus')}
                                    </a>
                                {/if}
                            </div>
                        </div>
                                            ...
                                            <nav aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    <li class="breadcrumb-item active"
                                                        aria-current="page">{$i18n->get('used-today')}
                                                        : {$user->TodayusedTraffic()}</li>
                                                </ol>
                                            </nav>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-stats">
                                        <div class="card-stats-title" style="padding-top: 0;padding-bottom: 4px;">
                                            <nav aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    <li class="breadcrumb-item active"
                                                        aria-current="page">{$i18n->get('total-aff-reward')}:
                                                        ¥{$paybacks_sum}</li>
                                                </ol>
                                            </nav>
                                        </div>
                                            ...
                                            {foreach $malio_config['share_account'] as $class_name => $class}
                                                <div class="accordion">
                                                    <div class="accordion-header collapsed" role="button"
                                                         data-toggle="collapse" data-target="#panel-body-{$class_name}"
                                                         aria-expanded="false">
                                                        <h4>{$class_name}</h4>
                                                    </div>
                                                    <div class="accordion-body collapse" id="panel-body-{$class_name}"
                                                        ...
                                                        {foreach $class as $account}
                                                            ...
                                                            {if $user->class >= $account['class']}
                                                                ...
                                                                {$i18n->get('password')}:
                                                                <a href="##" class="copy-text"
                                                                   data-clipboard-text="{$account['passwd']}">*********({$i18n->get('click-to-copy')}
                                                                    )</a>
                                                            {else}
                                        ...
                                        <div class="buttons">
                                            {if (in_array("ss",$malio_config['support_sub_type'])) || (in_array("v2ray",$malio_config['support_sub_type']))}
                                                {if (!in_array("clash",$malio_config['index_hidden_import_buttons']))}
                                                    <a href="##"
                                                       class="btn btn-icon icon-left btn-primary btn-clash btn-lg btn-round"
                                                       onclick="importSublink('clash')"><i
                                                                class="malio-clash"></i> {$i18n->get('import-clash-config')}
                                                    </a>
                                                {/if}
                                            {/if}
                                            ...
                                            {if (in_array("ss",$malio_config['support_sub_type'])) || (in_array("v2ray",$malio_config['support_sub_type']))}
                                                {if (!in_array("kitsunebi",$malio_config['index_hidden_import_buttons']))}
                                                    <a href="##"
                                                       class="btn btn-icon icon-left btn-primary btn-kitsunebi copy-text btn-lg btn-round"
                                                       data-clipboard-text="{$subInfo['kitsunebi']}"><i
                                                                class="malio-kitsunebi"></i> {$i18n->get('copy-kitsunebi-config-url')}
                                                    </a>
                                                {/if}
                                            {/if}
                                            ...
                                            {if (!in_array("quantumult",$malio_config['index_hidden_import_buttons']))}
                                                {if $malio_config['quantumult_mode'] == 'single'}
                                                    <a href="##" id="quan_sub"
                                                       class="btn btn-icon icon-left btn-primary btn-quantumult btn-lg btn-round copy-config"
                                                       onclick="importSublink('quantumult')"><i
                                                                class="malio-quantumult"></i> {$i18n->get('import-quantumult-config')}
                                                    </a>
                                            ...
                                            {if (!in_array("shadowrocket",$malio_config['index_hidden_import_buttons']))}
                                                <a href="##"
                                                   ...
                                                   onclick="importSublink('shadowrocket')"><i
                                                            class="malio-shadowrocket"></i> {$i18n->get('import-shadowrocket-config')}
                                                </a>
                                            {/if}
                                            {if (in_array("ss",$malio_config['support_sub_type']))}
                                                {if (!in_array("surge",$malio_config['index_hidden_import_buttons']))}
                                                    <div class="dropdown d-inline">
                                                        <button class="btn btn-primary btn-surge dropdown-toggle btn-icon btn-round btn-lg"
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start"
                                                            ...
                                                            <a class="dropdown-item" href="##"
                                                               onclick="importSublink('surge2')"> {$i18n->get('import-surge-version-config',['2'])}</a>
                                                            <a class="dropdown-item copy-text" href="##"
                                                               data-clipboard-text="{$subInfo['surge']}"> {$i18n->get('copy-surge-version-config-url',['2'])}</a>
                                                            <a class="dropdown-item" href="##"
                                                               onclick="importSublink('surge3')"> {$i18n->get('import-surge-version-config',['3'])}</a>
                                                            <a class="dropdown-item copy-text" href="##"
                                                               data-clipboard-text="{$subInfo['surge3']}"> {$i18n->get('copy-surge-version-config-url',['3'])}</a>
                                                            <a class="dropdown-item" href="##"
                                                               onclick="importSublink('surge4')"> {$i18n->get('import-surge-version-config',['4'])}</a>
                                                            <a class="dropdown-item copy-text" href="##"
                                                               data-clipboard-text="{$subInfo['surge4']}"> {$i18n->get('copy-surge-version-config-url',['4'])}</a>
                                                        </div>
                                                    </div>
                                                {/if}
                                                ...
                                                {if (!in_array("surfboard",$malio_config['index_hidden_import_buttons']))}
                                                    <a href="##"
                                                       class="btn btn-icon icon-left btn-primary btn-surfboard btn-lg btn-round"
                                                       onclick="importSublink('surfboard')"><i
                                                                class="malio-surfboard"></i> {$i18n->get('import-surfboard-config')}
                                                    </a>
                                                {/if}

                                                {if (!in_array("ss",$malio_config['index_hidden_import_buttons']))}
                                                    <a href="##"
                                                       class="btn btn-icon icon-left btn-primary btn-ss copy-text btn-lg btn-round"
                                                       data-clipboard-text="{$subInfo['ss']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}"><i
                                                                class="malio-ssr"></i> {$i18n->get('copy-ss-config-url')}
                                                    </a>
                                                {/if}
                                            ...
                                            {if (in_array("v2ray",$malio_config['support_sub_type']))}
                                                {if (!in_array("v2ray",$malio_config['index_hidden_import_buttons']))}
                                                    <a href="##"
                                                       class="btn btn-icon icon-left btn-primary btn-v2ray copy-text btn-lg btn-round"
                                                       data-clipboard-text="{$subInfo['v2ray']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}"><i
                                                                class="malio-v2rayng"></i> {$i18n->get('copy-v2ray-config-url')}
                                                    </a>
                                                {/if}
                                            ...
                                            {if (!in_array("ssd",$malio_config['index_hidden_import_buttons']))}
                                                <a href="##"
                                                   class="btn btn-icon icon-left btn-primary btn-quantumult copy-text btn-lg btn-round"
                                                   data-clipboard-text="{$subInfo['ssd']}"><i
                                                            class="malio-ssr"></i> {$i18n->get('copy-ssd-config-url')}
                                                </a>
                                            {/if}
                                            ...
                                            {if (in_array("ssr",$malio_config['support_sub_type']))}
                                                {if (!in_array("ssr",$malio_config['index_hidden_import_buttons']))}
                                                    <div class="dropdown d-inline">
                                                        <button class="btn btn-primary btn-ssr dropdown-toggle btn-icon btn-round btn-lg"
                                                                type="button" id="dropdownMenuButton"
                                                                data-toggle="dropdown" aria-haspopup="true"
                                                                aria-expanded="false">
                                                        ...
                                                        <div class="dropdown-menu" x-placement="bottom-start"
                                                             style="position: absolute; transform: translate3d(0px, 28px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                            <a class="dropdown-item" href="##"
                                                               onclick="importSublink('ssr')"> {$i18n->get('import-ssr-config')}</a>
                                                            <a class="dropdown-item copy-text" href="##"
                                                               data-clipboard-text="{$subInfo['ssr']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}"> {$i18n->get('copy-ssr-config-url')}</a>
                                                        </div>
                                                    </div>
                                                {/if}
                                            {/if}
                                            ...
                                            {if (!in_array("copy-ss",$malio_config['index_hidden_import_buttons']))}
                                                <a href="##" id="ss-all-urls"
                                                   class="btn btn-icon icon-left btn-primary btn-ss copy-config btn-lg btn-round"
                                                   onclick="Copyconfig('/user/getUserAllURL?type=ss','#ss-all-urls','')"><i
                                                            class="malio-ssr"></i> {$i18n->get('copy-ss-urls')}</a>
                                            {/if}

                                            {if (!in_array("copy-ssr",$malio_config['index_hidden_import_buttons']))}
                                                <a href="##" id="ssr-all-urls"
                                                   class="btn btn-icon icon-left btn-primary btn-ssr copy-config btn-lg btn-round"
                                                   onclick="Copyconfig('/user/getUserAllURL?type=ssr','#ssr-all-urls','')"><i
                                                            class="malio-ssr"></i> {$i18n->get('copy-ssr-urls')}</a>
                                            {/if}

                                            {if (!in_array("copy-vmess",$malio_config['index_hidden_import_buttons']))}
                                                <a href="##" id="v2ray-all-urls"
                                                   class="btn btn-icon icon-left btn-primary btn-v2ray copy-config btn-lg btn-round"
                                                   onclick="Copyconfig('/user/getUserAllURL?type=v2ray','#v2ray-all-urls','')"><i
                                                            class="malio-v2rayng"></i> {$i18n->get('copy-vmess-urls')}
                                                </a>
                                            {/if}
                                        </div>
                                    </div>
                ...
                <section class="section">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="animated tada mt-5 text-center" style="color:#191d21">👋
                                        Hi, {$user->user_name}</h3>
                                    <h5 class="mb-5 mt-2 text-center"
                                        style="color:#191d21d5">{$i18n->get('new-user-guide-lead')}</h5>
                                    <div class="row mt-4">
...
<script>
    ...
    function importSublink(client) {
        ...
        if (client == 'quantumultx') {
            oneclickImport('quantumultx', '{$subInfo["quantumultx"]}');
        }

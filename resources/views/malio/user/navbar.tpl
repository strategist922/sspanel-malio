...
{if $malio_config['enable_i18n'] == true}
    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link nav-link-lg nav-link-user"><i class="fas fa-language" style="vertical-align: -2px; padding-right: 2px;"></i> {if $i18n->lang == 'en'}English{else}简体中文{/if}</a>
...
<li><a class="nav-link" href="/user/shop"><i class="fas fa-store"></i> <span>{$i18n->get('store')}</span></a></li>
     ...
     {if $malio_config['enable_invite'] == true && $user->class >=0}
      <li><a class="nav-link" href="/user/invite"><i class="fas fas fa-fire" style="color:red;"></i> <span>{$i18n->get('aff')}</span></a></li>
      {/if}  
     ...
     {if $malio_config['enable_user_sub_log'] == true && $user->class >=0}
      ...
      <li><a class="nav-link" href="/user/tutorial?os=faq"><i class="fas fa-laptop-code"></i> <span>{$i18n->get('faq-desc')}</span></a></li>

                    ...
                    <ul class="steps">
                      <li>
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <a href="https://ghproxy.com/https://github.com/Kr328/ClashForAndroid/releases/download/v2.4.14/cfa-2.4.14-foss-arm64-v8a-release.apk" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> 下载客户端</a>
                          </div>
                      ...
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>点击这个按钮 👇👇👇</p>
                            <a href="##" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" onclick="importSublink('clash')"><i class="malio-clash"></i> 一键导入托管配置到 Clash for Android</a>
                            <p class="text-muted" style="font-size: 13px">一键导入不成功？<a href="#manual-import" class="text-muted "><u>试试手动导入</u> →</a></p>
                          
</div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                              <img src="https://tva2.sinaimg.cn/large/0088xB5sly1ghjnpfrcskj30bl0jy74p.jpg">
                            </div>
                          </div>
                        </div>
                      </li>
                      <li>
                        ...
                        <div class="row">
                          ...
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                              <img style="border:1px solid #f0f0f0" src="https://tva1.sinaimg.cn/large/0088xB5sly1ghjnpfsrc6j30br0k4dgi.jpg">
                            </div>
                          </div>
                        </div>
                      </li>
                    ...
                    <div class="faq">
                      <div class="row mt-2 mb-2">
                        <div class="col-sm-6 col-xs-12 col-md-6 col-lg-6" id="manual-import">
                          <h6>Clash for Android 无法一键导入，如何手动导入配置？</h6>
                          <p class="mb-4 font-13">
                            <a href="##" class="copy-text" data-clipboard-text="{$subInfo['clash']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}">点此复制 Clash 托管配置链接</a>， 打开客户端，点击 Profiles，点击 + New Profile，选择 URL，然后将 Name 填写为 {$config['appName']} ，将托管配置链接粘贴到 URL 的框内，点击右上角 ✓ 按钮即可。
                          </p>
			 </div>
<div class="col-sm-6 col-xs-12 col-md-6 col-lg-6" id="manual-import">
			<h6>一键导入也无效，试试另一个客户端</h6>
                          <p class="mb-4 font-13">
                            <a href="/user/tutorial?os=android&client=v2rayng" >点此跳转</a>
                          </p>
</div>

            ...
            <div class="section-header-breadcrumb">
              <div class="btn-group dropleft">
                ...
                <div class="dropdown-menu dropleft">
                  <a class="dropdown-item has-icon" href="/user/tutorial?os=ios&client=quantumultx"><i class="malio-atom"></i>QuantumultX</a>
                </div>
              </div>
            </div>
            {/if}
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            {if $malio_config['enable_ios_apple_id'] == true}
                              ...
                              <p><span style="color:red" ><i class="fas fa-exclamation-triangle"></span></i><b>登陆iCloud会导致您的隐私泄露请务必只登陆App Store。</b></p>
                              {if $user->class>0}
    ...
    {/if}
                      ...
                      <li>
                        ...
                        <div class="row">
                          ...
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                              <img style="border:1px solid #f0f0f0" src="https://i.loli.net/2019/04/10/5cade6faa94e8.png">
                            </div>
                      ...
                      <li>
                        ...
                        <div class="row">
                          ...
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                              <img style="border:1px solid #f0f0f0" src="https://i.loli.net/2019/04/10/5cade711922d8.png">
                            </div>

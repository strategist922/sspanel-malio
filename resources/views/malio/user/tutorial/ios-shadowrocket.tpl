                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="left-text col-xs-12 col-md-6 col-lg-6">
                                                    ...
                                                    <button id="shadowrocket-download-qrcode" type="button"
                                                ...
                                                <div class="left-text col-xs-12 col-md-6 col-lg-6">
                                                    ...
                                                    <a href="##"
                                                       ...
                                                       onclick="importSublink('shadowrocket')"><i
                                                                class="malio-shadowrocket"></i> 一键导入 Shadowrocket 配置</a>
                                                    <button id="shadowrocket-qrcode" type="button"
                                                            class="qrcode-btn btn">
                                                        <i class="fas fa-qrcode"></i>
                                                    </button>
                                                    <p class="text-muted" style="font-size: 13px">一键导入不成功？<a
                                                                href="#manual-import" class="text-muted "><u>试试手动导入</u>
                                                            →</a></p>
                                                </div>
                                                <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                                        ...
                                        <li>
                                            ...
                                            <div class="row">
                                                <div class="left-text col-xs-12 col-md-6 col-lg-6">
                                                    ...
                                                    <p>点击底栏的配置，选择添加配置，粘贴配置链接，下载。随后点击 远程文件
                                                        中新增的配置文件地址，在弹出的菜单中选择第二个「使用配置」，此时 APP
                                                        会自动开始下载配置并应用配置。回到首页，点击进入「全局路由」将其更改为 配置。</p>
                                                    <a href="##"
                                                       class="btn btn-icon icon-left btn-primary btn-app copy-text btn-lg btn-round"
                                                       data-clipboard-text="https://raw.githubusercontent.com/Hackl0us/Surge-Rule-Snippets/master/LAZY_RULES/Shadowrocket.conf"><i
                                                                class="far fa-copy"></i> 复制配置链接</a>
                                                </div>
                                                <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                                                    <div class="tutorial-pic">
                                                        <img style="border:1px solid #f0f0f0"
                                                             src="https://i.loli.net/2019/04/10/5cade6faa94e8.png">
                                                    </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                                                    <div class="tutorial-pic">
                                                        <img style="border:1px solid #f0f0f0"
                                                             src="https://i.loli.net/2019/04/10/5cade711922d8.png">
                                                    </div>
                                    ...
                                    <div class="faq">
                                        <div class="row mt-2">
                                            <div id="manual-import" class="col-sm-6 col-xs-12 col-md-6 col-lg-6">
                                                ...
                                                <p class="mb-4 font-13">
                                                    <a href="##" class="copy-text"
                                                       data-clipboard-text="{$subInfo['shadowrocket']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}">点此复制
                                                        Shadowrocket 订阅链接</a>，打开 Shadowrocket
                                                    首页，点击右上角的加号，再次点击第一行的「类型」，选择 Subscribe。在「备注」中输入{$config['appName']}
                                                    ，随后在「URL」中粘贴订阅链接。
                                                </p>
                                            </div>
                                            <div class="col-sm-6 col-xs-12 col-md-6 col-lg-6">
                                                ...
                                                <p class="mb-4 font-13">
                                                    在首页找到名称为{$config['appName']}的服务器订阅，点击右边的 ⓘ
                                                    ，点击右上角完成。我们建议用户打开自动更新开关，点击底部导航栏的「设置」进入设置页面，随后往下划至最底部，进入「服务器订阅」子页面。将「打开时更新」的开关
                                                    打开。
                                                </p>
                                            </div>
                                        </div>

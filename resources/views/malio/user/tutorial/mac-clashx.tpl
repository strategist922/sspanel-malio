            ...
            <div class="section-header-breadcrumb">
              <div class="btn-group dropleft">
                ...
                <div class="dropdown-menu dropleft">
                  <a class="dropdown-item has-icon" href="/user/tutorial?os=mac&client=ssxgr"><i class="malio-ssr"></i>V2rayU</a>
                </div>
              </div>
            </div>
            {/if}
                      ...
                      <li>
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <a href="https://ghproxy.com/https://github.com/yichengchen/clashX/releases/download/1.90.0/ClashX.dmg" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> 下载客户端</a>
                          </div>

            ...
            <div class="section-header-breadcrumb">
              <div class="btn-group dropleft">
                ...
                <div class="dropdown-menu dropleft">
                  <a class="dropdown-item has-icon" href="/user/tutorial?os=windows&client=cfw"><i class="malio-v2rayng"></i>V2rayN</a>
                </div>
              </div>
            </div>
            {/if}
...
<p><a href="https://aka.ms/dotnet/5.0/windowsdesktop-runtime-win-x64.exe">第一次使用请务必先安装 .NET 5.0 运行库</a></p>
                            <p>下载 Netch 客户端，全部解压到一个文件夹后以管理员身份运行 Netch.exe。若系统仍英文提示提示需要安装.NET运行库重启系统即可解决</p>
                            <a href="https://ghproxy.com/?q=https%3A%2F%2Fgithub.com%2Fnetchx%2Fnetch%2Freleases%2Fdownload%2F1.9.2%2FNetch.7z" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> 下载客户端</a>
                          </div>
                      ...
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            <label class="step-no">2.</label>
                            <p>粘贴订阅链接到左下角的链接，备注任意填写，点击添加，然后点击保存后更新服务器</p>
                      ...
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>在服务器选择一个节点并在模式中选择需要加速的游戏，点击右下角启动即可达到加速效果。如果需要加速的游戏不在列表里面，那么就选中 “模式” > “创建进程模式”</p>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">

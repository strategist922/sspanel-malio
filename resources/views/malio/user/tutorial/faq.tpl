                  ...
                  <div class="card-body" style="color:black">
                    ...
                    <ol>
                    	<li>
                    		...
                    		A：相同的咖啡猫订阅（例高级和高级，专业和专业，A1和B1）可叠加购买，时间和流量都会叠加，流量叠加只计算重复购买的当月后续按订阅内包含流量进行重置；<br>
                            高级咖啡猫订阅不支持升级专业咖啡猫订阅，时间和流量都会重置；<br>
                            专业咖啡猫不订阅支持降级高级咖啡猫订阅，时间和流量都会重置；<br>
                            相同流量包重复购买可叠加，时间和流量都会叠加，流量包不可和其他订阅叠加<br>
                            原套餐为非流量包套餐购买流量包时，时间和流量都会重置<br>
                            <strong>注1：如果因为没看清规则导致购买错误而时间/流量叠加失败，可开启工单处理，管理员会按情况帮忙补回。（每个账户仅限一次）<br>
				注2：购买多个订阅时若均勾选自动续费，每个订阅会在30个自然日后独立计算扣费，您可以在钱包界面按需保留，取消后不支持重新开通。例：张三注册账户后在3月1日购买了两个"A1-高级订阅-月度"且均在购买时勾选了自动续费，则张三在3月31号收到扣费账单24元，张三又获得了两个月订阅计时总计三个月。</strong>
                    		</p>
                    	</li>
                    	<li>
                    ...
                    <ol>
                    	...
                    	<li>
                            ...
                            有标注倍率的节点均为特殊节点，无限流量套餐的用户在特殊节点消耗的流量将无法免费重置。
                    		</p>
                    	</li>

                      ...
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <a href="##" id="quan_sub" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round copy-config" onclick="Copyconfig(&quot;{$subInfo['quantumult_sub']}&quot;,&quot;#quan_sub&quot;,&quot;quantumult-x:///update-configuration?remote-resource=%7B%0A%20%20%20%20%22&quot;)"><i class="malio-quantumult"></i> 一键导入 Quantumult X配置</a>
                            {/if}

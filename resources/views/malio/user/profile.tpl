                        ...
                        <div class="col-lg-6">
                            <div class="card card-large-icons">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="##" class="card-cta" data-toggle="modal"
                                       data-target="#change-password-modal">{$i18n->get('change')} <i
                            ...
                            <div class="col-lg-6">
                                <div class="card card-large-icons">
                                    ...
                                    <div class="card-body">
                                        ...
                                        {else}
                                            <p>{$i18n->get('currently-connected-to-telegram-account')}<a
                                                        href="https://t.me/{$user->im_value}"
                                                        target="blank">@{$user->im_value}</a></p>
                                        {/if}
                                        <a href="##" class="card-cta" data-toggle="modal"
                                           data-target="#telegram-modal">{if $user->telegram_id == 0}{$i18n->get('telegram-connect')}{else}{$i18n->get('connect-to-another-account')}{/if}
                                ...
                                <div class="card card-large-icons">
                                    ...
                                    <div class="card-body">
                                        ...
                                        {if $user->ga_enable==1}
                                            ...
                                            <a href="##" id="2fa-off" class="card-cta">{$i18n->get('disable-2fa')} <i
                                                        class="fas fa-chevron-right"></i></a>
                                        {else}
                                            <p>{$i18n->get('2fa-desc')}</p>
                                            <a href="##" class="card-cta" data-toggle="modal"
                                               data-target="#ga-modal">{$i18n->get('2fa-enable')} <i
                                                        class="fas fa-chevron-right"></i></a>
                                        {/if}
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card card-large-icons">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="##" class="card-cta" data-toggle="modal"
                                           data-target="#kill-modal">{$i18n->get('delete-account-button')} <i
                                                    class="fas fa-chevron-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card card-large-icons">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4>{$i18n->get('send-mail-change')}
                                        :{if $user->sendDailyMail===0}{$i18n->get('ticket-closed')}{else}{$i18n->get('ticket-open')}{/if}</h4>
                                    <p>{$i18n->get('send-mail-info')}</p>
                                    {if $user->sendDailyMail===0}
                                        <a href="##" onclick="email_change('1')"
                                           class="card-cta">{$i18n->get('enable-send-mail')}<i
                                                    class="fas fa-chevron-right"></i></a>
                                    {else}
                                        <a href="##" onclick="email_change('0')"
                                           class="card-cta">{$i18n->get('disable-send-mail')}<i
                                                    class="fas fa-chevron-right"></i></a>
                                    {/if}
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer bg-whitesmoke br">
                <button type="button" class="btn btn-primary"
                        onclick="passwordConfirm()">{$i18n->get('change-password-modal-confirm')}</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    <button type="button" class="btn btn-danger"
                            onclick="killConfirm()">{$i18n->get('delete-account-confirm')}</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{$i18n->get('cancel')}</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="ga-setp-2-modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    <button type="button" class="btn btn-primary"
                            onclick="twofaConfirm()">{$i18n->get('enable')}</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{$i18n->get('cancel')}</button>
                </div>
            </div>
        </div>

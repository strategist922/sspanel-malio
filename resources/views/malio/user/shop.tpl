                ...
                <div class="row" id="plan-selection">
                  <div class="col-md-12">
                    ...
                    <div class="colors">
                      ...
                      <div id="{$name}" class="color col-12 col-md-2 col-lg-2 active" onclick="selectItem('plan','{$name}')">
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-4 col-lg-4">
                <div class="pricing pricing-highlight">
                  ...
                  <div class="pricing-cta">
                    <a href="##" data-toggle="modal" data-target="#legacy-modal-1" onclick="legacySelect({$shop->id})">
{if {$user->class}=={$shop->user_class()}}
{$i18n->get('purchase')}(可疊加)
{/if}
{if {$user->class}!={$shop->user_class()} && {$user->class>0}}
{$i18n->get('purchase')}(不可疊加)
{/if}
{if {$user->class}<1}
{$i18n->get('purchase')}
{/if}

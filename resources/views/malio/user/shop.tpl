                            ...
                            <div class="section-header-breadcrumb">
                                <div class="breadcrumb-item active">
                                    <a href="#" class="btn btn-icon icon-left btn-primary" data-toggle="modal"
                                       data-target="#traffic-package-modal"><i
                                                class="fas fa-gas-pump"></i> {$i18n->get('purchase-data-add-on')}</a>
                                </div>
                            </div>
                        {/if}
                    </div>
                                ...
                                <div class="col-12 col-md-3 col-lg-3">
                                    <div class="pricing pricing-highlight">
                                        ...
                                        <div class="pricing-cta">
                                            <a href="##"
                                               onclick="buyConfirm({$malio_config['shop_trail_plan_shopid']})">{$i18n->get('start-trail')}
                ...
                <section class="section">
                    <div class="section-header">
                        <div class="section-header-back">
                            <a href="##" onclick="backToShop()" class="btn btn-icon"><i
                                ...
                                <div class="row" id="plan-selection">
                                    <div class="col-md-12">
                                        <div class="section-title"
                                             style="margin-top: 0;">{$i18n->get('choose-plan')}</div>
                                        <div class="colors">
                                            {foreach $I18N['plans-info'][$i18n->lang] as $name => $plan}
                                                {$price_exploded = explode(".",$plan['price'])}
                                                <div id="{$name}" class="color col-12 col-md-2 col-lg-2 active"
                                                     onclick="selectItem('plan','{$name}')">
                        <span class="pricing-inside">
                        <span class="pricing-super">¥</span>
                        {intval($plan['price'])}
                        <span class="pricing-super">.{if count($price_exploded) == 2}{$price_exploded[1]}{else}0{/if}
                        </span>
                        <span class="per-month">/{$i18n->get('mo')}</span>
                        </span>
                                ...
                                <div class="row mt-4" id="time-selection">
                                    <div class="col-12">
                                        ...
                                        <div class="colors">
                                            <div id="1month" class="color col-12 col-md-2 col-lg-2 active"
                                                 onclick="selectItem('time','1month')">
                                                {$i18n->get('1-month')}
                                            </div>
                                            <div id="3month" class="color col-12 col-md-2 col-lg-2"
                                                 onclick="selectItem('time','3month')">
                                                {$i18n->get('3-months')}
                                            </div>
                                            <div id="6month" class="color col-12 col-md-2 col-lg-2"
                                                 onclick="selectItem('time','6month')">
                                                {$i18n->get('6-months')}
                                            </div>
                                            <div id="12month" class="color col-12 col-md-2 col-lg-2"
                                                 onclick="selectItem('time','12month')">
                                                {$i18n->get('12-months')}
                                            </div>
                                    ...
                                    <div class="row mt-4" id="autorenew-selection">
                                        <div class="col-12">
                                            ...
                                            <div class="colors row">
                                                <div id="autorenew-off" class="color col-12 col-md-2 col-lg-2 active"
                                                     onclick="selectItem('autorenew','autorenew-off')">
                                                    {$i18n->get('autorenew-disable')}
                                                </div>
                                                <div id="autorenew-on" class="color col-12 col-md-2 col-lg-2"
                                                     onclick="selectItem('autorenew','autorenew-on')">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="colors row">
                                            {if $config['payment_system'] != malio}
                                                <div id="alipay" class="color col-12 col-md-2 col-lg-2 active"
                                                     onclick="selectItem('payment','alipay')">
                                                    <i class="fab fa-alipay"
                                                       style="font-size: 1.1rem;vertical-align: -1px;margin-right: 2px;"></i> {$i18n->get('alipay')}
                                                </div>
                                                {if $config['payment_system'] != 'f2fpay' && $config['payment_system'] != 'spay' && $config['payment_system'] != 'payssion'}
                                                    <div id="wechat" class="color col-12 col-md-2 col-lg-2"
                                                         onclick="selectItem('payment','wechat')">
                                                        <i class="malio-wechat-pay"
                                                           style="font-size: 1.1rem;vertical-align: -1px;"></i> {$i18n->get('wechat-pay')}
                                                    </div>
                                                {/if}
                                                {if $config['payment_system'] == 'bitpayx'}
                                                    <div id="crypto" class="color col-12 col-md-2 col-lg-2"
                                                         onclick="selectItem('payment','crypto')">
                                                        <i class="fab fa-btc"></i> {$i18n->get('cryptocurrency')}
                                                    </div>
                                                {/if}
                                                {if $config['payment_system'] == 'codepay' || $config['payment_system'] == 'flyfoxpay'}
                                                    <div id="qqpay" class="color col-12 col-md-2 col-lg-2"
                                                         onclick="selectItem('payment','qqpay')">
                                                        <i class="fab fa-qq"></i> {$i18n->get('qq-wallet')}
                                                    </div>
                                                {/if}
                                                {if $config['payment_system'] == 'payssion'}
                                                    <div id="unionpay" class="color col-12 col-md-2 col-lg-2"
                                                         onclick="selectItem('payment','unionpay')">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-lg-4 text-right">
                                        ...
                                        <div class="invoice-detail-item">
                                            ...
                                            <div id="pay-amount" class="invoice-detail-value invoice-detail-value-lg">
                                                Null
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="text-md-right">
                                    <div class="float-lg-left mb-lg-0 mb-3">
                                        <button id="coupon-btn" class="btn btn-primary btn-icon icon-left"
                                                data-toggle="modal" data-target="#coupon-modal"><i
                                                    class="fas fa-tag"></i> {$i18n->get('apply-promo-code')}</button>
                                    </div>
                                    <button id="pay-confirm" class="btn btn-warning btn-icon icon-left"><i
                                                class="fas fa-check"></i> {$i18n->get('pay-now')}</button>
                                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input id="coupon-code" type="text" class="form-control"
                               onclick="hideFeedback('coupon-feedback')">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    <button onclick="updateCoupon()" type="button"
                            class="btn btn-primary">{$i18n->get('validate-code')}</button>
                    <button onclick="cancelCoupon()" type="button" class="btn btn-secondary"
                            data-dismiss="modal">{$i18n->get('cancel')}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="f2fpay-modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    <a id="to-alipay-app" href="##" target="blank"
                       class="btn btn-primary">{$i18n->get('go-to-alipay-app')}</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="tmtpay-modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    <a id="to-tmtpay" href="##" type="button" target="blank"
                       class="btn btn-primary">{$i18n->get('continue-pay')}</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="payssion-modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    <a id="to-payssion" href="##" type="button" target="blank"
                       class="btn btn-primary">{$i18n->get('continue-pay')}</a>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="flyfox-modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    <a id="to-flyfox" href="##" type="button" target="blank"
                       class="btn btn-primary">{$i18n->get('continue-pay')}</a>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="yftpay-modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    <a id="to-yftpay" href="##" type="button" target="blank"
                       class="btn btn-primary">{$i18n->get('continue-pay')}</a>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="traffic-package-modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    ...
                    <div class="form-group">
                        ...
                        {foreach $malio_config['shop_traffic_packages'] as $package}
                            <div class="custom-control custom-radio">
                                <input type="radio" value="{$package['shopid']}" id="tp-{$package['shopid']}"
                                       name="traffic-package-radio" class="custom-control-input"
                                       {if $traffic_package_counter == 0}checked{$traffic_package_counter = 1}{/if}>
                ...
                <div class="modal-footer bg-whitesmoke br">
                    <button onclick="buyTrafficPackage()" type="button" data-dismiss="modal"
                            class="btn btn-primary">{$i18n->get('purchase')}</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input id="legacy-coupon" type="text" class="form-control" placeholder=""
                               onclick="hideFeedback('legacy-coupon-feedback')">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    <button onclick="legacyModalNext()" type="button" target="blank"
                            class="btn btn-primary">{$i18n->get('next')}</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{$i18n->get('cancel')}</button>
                </div>
            </div>
        </div>
                    ...
                    {if $malio_config['shop_enable_autorenew'] == true}
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label"
                                   for="legacy-autorenew">{$i18n->get('enable')} {$i18n->get('autorenew')}</label>
                        </div>
                    {/if}
                </div>
                <div class="modal-footer bg-whitesmoke br">
                    <button onclick="legacyBuy()" type="button" target="blank" class="btn btn-primary"
                            data-dismiss="modal">{$i18n->get('confirm')}</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{$i18n->get('cancel')}</button>
                </div>
            </div>
        </div>
...
{/if}
{if $config['payment_system'] == 'paytaro'}
    <div class="modal fade" tabindex="-1" role="dialog" id="paytaro-modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">支付</h5>
                ...
                <div class="modal-footer bg-whitesmoke br">
                    <a id="to-paytaro" href="##" type="button" target="blank" class="btn btn-primary">继续支付</a>
                </div>
            </div>
        </div>
    </div>

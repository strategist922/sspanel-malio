                        ...
                        <div class="col-12">
                            <div class="card card-hero">
                                <div class="card-header" style="border-radius: 3px;box-shadow: 0 2px 6px #acb5f6;border: none;">
                                    ...
                                    <div class="col-12">
                                        <a href="##"  id="top-up" class="btn btn-outline-white btn-lg btn-icon icon-left col-sm-12 col-md-2">
                                            <i class="fas fa-piggy-bank  col-xs-12"></i> {$i18n->get('top-up')}
                                        </a>
                                        <a href="" target="_block" class="btn btn-outline-white btn-lg btn-icon icon-left col-sm-12 col-md-2" >
                                            <i class="fas fa-dollar-sign"></i> {$i18n->get('redeem-gift-code1')}
                                        </a>
                                        {if $malio_config['enable_topup_code'] == true}
                                        <a href="##" class="btn btn-outline-white btn-lg btn-icon icon-left  col-sm-12 col-md-2" data-toggle="modal" data-target="#code-topup-modal">
                                            ...
                                            <div class="selectgroup w-100">
                                                {if $config['payment_system'] != malio}
                                                  ...
                                                  <span class="selectgroup-button selectgroup-button-icon"><i class="fab fa-qq mr-1"></i>{$i18n->get('qq-wallet')}</span>
                                                    ...
                                                    {/if}
                                                {else}
                                                    {if $malio_config['mups_alipay'] != 'none' && $malio_config['mups_alipay']!=''}
                                                        <label class="selectgroup-item">
                                                    ...
                                                    {/if}
                                                    {if $malio_config['mups_alipay_1'] != 'none' && $malio_config['mups_alipay']!=''}
                                                        <label class="selectgroup-item">
                                                    ...
                                                    {/if}
                                                    {if $malio_config['mups_alipay_2'] != 'none' && $malio_config['mups_alipay']!=''}
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="payment" value="alipay_1"
                                                                   class="selectgroup-input alipay" checked="">
                                                            <span class="selectgroup-button selectgroup-button-icon"><i
                                                    ...
                                                    {/if}
                                                    {if $malio_config['mups_wechat'] != 'none' && $malio_config['mups_alipay'] != ''}
                                                        <label class="selectgroup-item">

                        ...
                        <div class="col-12">
                            <div class="card card-hero">
                                <div class="card-header"
                                     style="border-radius: 3px;box-shadow: 0 2px 6px #acb5f6;border: none;">
                                    <div class="card-icon">
                                    ...
                                    <div class="col-12">
                                        <a href="##" id="top-up"
                                           class="btn btn-outline-white btn-lg btn-icon icon-left col-sm-12 col-md-2">
                                            <i class="fas fa-piggy-bank  col-xs-12"></i> {$i18n->get('top-up')}
                                        </a>
                                        <a href="" target="_block"
                                           class="btn btn-outline-white btn-lg btn-icon icon-left col-sm-12 col-md-2">
                                            <i class="fas fa-dollar-sign"></i> {$i18n->get('redeem-gift-code1')}
                                        </a>
                                        {if $malio_config['enable_topup_code'] == true}
                                            <a href="##"
                                               class="btn btn-outline-white btn-lg btn-icon icon-left  col-sm-12 col-md-2"
                                               data-toggle="modal" data-target="#code-topup-modal">
                                                <i class="fas fa-barcode"></i> {$i18n->get('redeem-gift-code')}
                                            </a>
                                        {/if}
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-md">
                                            ...
                                            {if count($codes) == 0}
                                                <tr>
                                                    <td colspan="4"><strong>{$i18n->get('no-top-up-history')}</strong>
                                                    </td>
                                                </tr>
                                            {else}
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-md">
                                            ...
                                            {if count($shops) == 0}
                                                <tr>
                                                    <td colspan="3"><strong>{$i18n->get('no-purchase-history')}</strong>
                                                    </td>
                                                </tr>
                                            {else}
                                                        ...
                                                        {if $malio_config['shop_enable_autorenew'] == true}
                                                            ...
                                                            <td>
                                                                {if $shop->renew==0}
                                                                    {$i18n->get('no-action')}
                                                                {else}
                                                                    <a href="#" onclick="stopAutorenew({$shop->id})"
                                                                       class="btn btn-primary">{$i18n->get('turn-off-auto-renewal')}</a>
                                                                {/if}
                                                            </td>
                                                        {/if}
                                                    </tr>
                            ...
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            ...
                                            {else}
                                                <div class="input-group">
                                                    ...
                                                    <input id="amount" type="number" class="form-control currency"
                                                           onclick="hideFeedback('no-amount-warn')">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <button id="topup-confirm"
                                                    class="btn btn-primary">{$i18n->get('top-up')}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
{/if}
{if $config['payment_system'] == 'theadpay' || $config['payment_system'] == 'f2fpay' || $config['payment_system'] == 'f2fpay_payjs'}

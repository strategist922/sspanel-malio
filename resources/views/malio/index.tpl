    ...
    <div class="hero">
      <div class="container">
        <div class="text text-center text-lg-left">
          ...
          <div class="cta">
            <a class="btn btn-lg btn-warning btn-icon icon-right" href="/auth/register">{$i18n->get('get-started')} <i class="fas fa-chevron-right"></i></a> &nbsp;
          </div>
          {if $user->isLogin}
      ...
      <div class="row">
        <div class="col-md-5">
          ...
          <div class="pr-lg-5">
            ...
            <p>&copy; {$config['appName']}&nbsp;&bull;&nbsp;2022 &copy; <br>Powered by <a href="/staff">SSPANEL</a></p>

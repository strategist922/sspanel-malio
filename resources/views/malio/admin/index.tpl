                                ...
                                <div class="card-inner">
                                    ...
                                    {foreach $days as $day}
                                        <button class="mdl-button mdl-js-button mdl-button--raised"
                                                onclick="getIncome('{$day}')">{$day}</button>
                                    {/foreach}
                                                ...
                                                data: [
                                                    {
                                                        ...
                                                        dataPoints: [
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                legendText: "一天内在线 {number_format(($sts->getOnlineUser(86400)-$sts->getOnlineUser(3600))/$sts->getTotalUser()*100,2)}% {($sts->getOnlineUser(86400)-$sts->getOnlineUser(3600))}人",
                                                                indexLabel: "一天内在线 {number_format(($sts->getOnlineUser(86400)-$sts->getOnlineUser(3600))/$sts->getTotalUser()*100,2)}% {($sts->getOnlineUser(86400)-$sts->getOnlineUser(3600))}人"
                                                            },
                                                            {
                        ...
                        <div class="card">
                            <div class="card-main">
                                <div class="card-inner">
                                    ...
                                    {foreach $days as $day}
                                        <button class="mdl-button mdl-js-button mdl-button--raised"
                                                onclick="getNewUsers('{$day}')">{$day}</button>
                                    {/foreach}
...
即将到账：${data.taIncome}<br>
三日总计：${data.threeDaysIncome}<br>
本周收入：${data.thisWeekIncome}<br>
上周收入：${data.lastWeekIncome}<br>
本月收入：${data.thisMonthIncome}
上月收入：${data.lastMonthIncome}<br>`;
